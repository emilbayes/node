...
// Test OOB
{
  ...
  ['Int8', 'Int16BE', 'Int16LE', 'Int32BE', 'Int32LE', 'Int64BE', 'Int64LE'].forEach((fn) => {
...
// Test 64 bit integers
{
  ...
  assert.strictEqual(buffer.readInt64BE(0), BigInt.asIntN(64, 0x435316793617abfen));
  assert.strictEqual(buffer.readInt64LE(0), BigInt.asIntN(64, 0xfeab173679165343n));
  ...
  buffer[6] = 0x95;
  buffer[7] = 0xa9;
  assert.strictEqual(buffer.readInt64BE(0), BigInt.asIntN(64, 0xfffeeffa42c395a9n));
  assert.strictEqual(buffer.readInt64LE(0), BigInt.asIntN(64, 0xa995c342faeffeffn));
  ...
  buffer[6] = 0xef;
  buffer[7] = 0xfa;
  assert.strictEqual(buffer.readInt64BE(0), BigInt.asIntN(64, 0x42c395a9fffeeffan));
  assert.strictEqual(buffer.readInt64BE(1), BigInt.asIntN(64, 0xc395a9fffeeffaban));
  assert.strictEqual(buffer.readInt64BE(2), BigInt.asIntN(64, 0x95a9fffeeffaba1an));
  assert.strictEqual(buffer.readInt64BE(3), BigInt.asIntN(64, 0xa9fffeeffaba1a21n));
  assert.strictEqual(buffer.readInt64BE(4), BigInt.asIntN(64, 0xfffeeffaba1a2121n));
  assert.strictEqual(buffer.readInt64LE(0), BigInt.asIntN(64, 0xfaeffeffa995c342n));
  assert.strictEqual(buffer.readInt64LE(1), BigInt.asIntN(64, 0xbafaeffeffa995c3n));
  assert.strictEqual(buffer.readInt64LE(2), BigInt.asIntN(64, 0x1abafaeffeffa995n));
  assert.strictEqual(buffer.readInt64LE(3), BigInt.asIntN(64, 0x211abafaeffeffa9n));
  assert.strictEqual(buffer.readInt64LE(4), BigInt.asIntN(64, 0x21211abafaeffeffn));
}
