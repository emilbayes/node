...
// Test 64 bit
{
  ...
  writeInt64BE(buffer, 0x23, 0);
  writeInt64LE(buffer, 0x23, 8);
  assert.ok(0 === Buffer.compare(buffer, new Uint8Array([
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x23,
    0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
  ])));

  writeInt64BE(buffer, -5, 0);
  writeInt64LE(buffer, -5, 8);
  assert.ok(0 === Buffer.compare(buffer, new Uint8Array([
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfb,
    0xfb, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
  ])));

  writeInt64BE(buffer, -805306713, 0);
  writeInt64LE(buffer, -805306713, 8);
  assert.ok(0 === Buffer.compare(buffer, new Uint8Array([
    0xff, 0xff, 0xff, 0xff, 0xcf, 0xff, 0xfe, 0xa7,
    0xa7, 0xfe, 0xff, 0xcf, 0xff, 0xff, 0xff, 0xff
  ])));
