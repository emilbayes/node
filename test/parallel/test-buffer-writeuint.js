...
{ // OOB
  ...
  ['UInt8', 'UInt16BE', 'UInt16LE', 'UInt32BE', 'UInt32LE', 'UInt64BE', 'UInt64LE'].forEach((fn) => {
...
// Test 64 bit
{
  ...
  assert.ok(data.equals(new Uint8Array([0xe7, 0xf9, 0x0a, 0x6d, 0xba, 0xcd, 0x09, 0x81, 0x00, 0x00, 0x00, 0x00])));

  data.writeUInt64BE(value, 1);
  assert.ok(data.equals(new Uint8Array([0xe7, 0xe7, 0xf9, 0x0a, 0x6d, 0xba, 0xcd, 0x09, 0x81, 0x00, 0x00, 0x00])));

  data.writeUInt64BE(value, 2);
  assert.ok(data.equals(new Uint8Array([0xe7, 0xe7, 0xe7, 0xf9, 0x0a, 0x6d, 0xba, 0xcd, 0x09, 0x81, 0x00, 0x00])));

  data.writeUInt64BE(value, 3);
  assert.ok(data.equals(new Uint8Array([0xe7, 0xe7, 0xe7, 0xe7, 0xf9, 0x0a, 0x6d, 0xba, 0xcd, 0x09, 0x81, 0x00])));

  data.writeUInt64BE(value, 4);
  assert.ok(data.equals(new Uint8Array([0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xf9, 0x0a, 0x6d, 0xba, 0xcd, 0x09, 0x81])));

  data.writeUInt64LE(value, 0);
  assert.ok(data.equals(new Uint8Array([0x81, 0x09, 0xcd, 0xba, 0x6d, 0x0a, 0xf9, 0xe7, 0xba, 0xcd, 0x09, 0x81])));

  data.writeUInt64LE(value, 1);
  assert.ok(data.equals(new Uint8Array([0x81, 0x81, 0x09, 0xcd, 0xba, 0x6d, 0x0a, 0xf9, 0xe7, 0xba, 0xcd, 0x09])));

  data.writeUInt64LE(value, 2);
  assert.ok(data.equals(new Uint8Array([0x81, 0x81, 0x81, 0x09, 0xcd, 0xba, 0x6d, 0x0a, 0xf9, 0xe7, 0xba, 0xcd])));

  data.writeUInt64LE(value, 3);
  assert.ok(data.equals(new Uint8Array([0x81, 0x81, 0x81, 0x81, 0x09, 0xcd, 0xba, 0x6d, 0x0a, 0xf9, 0xe7, 0xba])));

  data.writeUInt64LE(value, 4);
  assert.ok(data.equals(new Uint8Array([0x81, 0x81, 0x81, 0x81, 0x81, 0x09, 0xcd, 0xba, 0x6d, 0x0a, 0xf9, 0xe7])));
}
